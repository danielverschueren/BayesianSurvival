...
if __name__ == "__main__":
    ...
    if load:
        with open('PosteriorWeibullPembroX.pk', 'rb') as f:
        ...
        # save runs
        with open('PosteriorWeibullPembroX.pk', 'wb') as handle:
            pickle.dump(PosteriorsT, handle)

    # plot Exp Posteriors
    num_shows=6
    _, ax1 = plt.subplots(1, 2, figsize=(10,4))
    ax1 = plotPosteriors(PosteriorsT, 'b', ax1, num_shows, beta_prior, b_prior)
    #plt.show()
